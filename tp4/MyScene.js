...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.minecraftCube = new MyUnitCubeQuad(this);
        ...
        //------ tangram object applied material
        ...
        //minecraft cube top
        this.cubeTopMaterial = new CGFappearance(this);
        this.cubeTopMaterial.setAmbient(0.1, 0.1, 0.1, 1);
        this.cubeTopMaterial.setDiffuse(0.9, 0.9, 0.9, 1);
        this.cubeTopMaterial.setSpecular(0.1, 0.1, 0.1, 1);
        this.cubeTopMaterial.setShininess(10.0);
        this.cubeTopMaterial.loadTexture('images/mineTop.png');
        this.cubeTopMaterial.setTextureWrap('REPEAT', 'REPEAT');
        
        //minecraft cube bottom
        this.cubeBottomMaterial = new CGFappearance(this);
        this.cubeBottomMaterial.setAmbient(0.1, 0.1, 0.1, 1);
        this.cubeBottomMaterial.setDiffuse(0.9, 0.9, 0.9, 1);
        this.cubeBottomMaterial.setSpecular(0.1, 0.1, 0.1, 1);
        this.cubeBottomMaterial.setShininess(10.0);
        this.cubeBottomMaterial.loadTexture('images/mineBottom.png');
        this.cubeBottomMaterial.setTextureWrap('REPEAT', 'REPEAT');

        //minecraft cube side
        this.cubeSideMaterial = new CGFappearance(this);
        this.cubeSideMaterial.setAmbient(0.1, 0.1, 0.1, 1);
        this.cubeSideMaterial.setDiffuse(0.9, 0.9, 0.9, 1);
        this.cubeSideMaterial.setSpecular(0.1, 0.1, 0.1, 1);
        this.cubeSideMaterial.setShininess(10.0);
        this.cubeSideMaterial.loadTexture('images/mineSide.png');
        this.cubeSideMaterial.setTextureWrap('REPEAT', 'REPEAT');
        ...
        this.objects = [this.quad, this.tangram, this.minecraftCube];
    ...
    display() {
        ...
        if (this.selectedObject == this.objectIds["Tangram"]) {
            this.pushMatrix();
