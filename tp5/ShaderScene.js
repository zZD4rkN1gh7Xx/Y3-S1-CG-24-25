...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			//added
			new CGFshader(this.gl, "shaders/positionRelative.vert", "shaders/positionRelative.frag"),
			new CGFshader(this.gl, "shaders/texture1.vert", "shaders/sepia_gray.frag")
		];
		...
		this.testShaders[6].setUniformsValues({ scaleFactor: this.scaleFactor }); //added
	...
	onScaleFactorChanged(v) {
		...
		this.testShaders[6].setUniformsValues({ normScale: this.scaleFactor,
